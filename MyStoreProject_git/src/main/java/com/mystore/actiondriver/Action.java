...
public class Action extends BaseClass {
     ...
     *
     * @param container The WebElement representing the container element (e.g., the `<div>`).
     * @param selectLocator A locator (By object) to identify the `<select>` element within the container.
	...
	public boolean selectByValuejs(WebElement dropdownElement, String value) {
	    ...
	    try {
	        ...
	        // Locate the dropdown options and iterate through them to find the desired value
	        List<WebElement> options = dropdownElement.findElements(By.tagName("option"));
	        for (WebElement option : options) {
